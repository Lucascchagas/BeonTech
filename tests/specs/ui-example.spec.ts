...
test.describe('e2e', () => {
  test.describe.serial('Google Search', () => {
    test('Access Facebook sign-up screen', async ({ page }) => {
      ...
      await methods.validateMetaDescription(
        'Meta Platforms, Inc. é um conglomerado estadunidense de tecnologia e mídia social com sede em Menlo Park, Califórnia.',
      );
    });
  });
});
